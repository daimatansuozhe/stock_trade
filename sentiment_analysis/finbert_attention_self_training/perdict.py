...
from local_model.finbert_chinese.modeling_finbert import BertForSequenceClassification
import pandas as pd
import os
import numpy as np
import torch
...
if __name__=="__main__":
    ...
    model = BertForSequenceClassification.from_pretrained(local_path, config=config)
